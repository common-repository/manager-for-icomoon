...
function Edit(props) {
  ...
  const insertIcon = (iconData, customOptions) => {
    ...
    let shortcode = `[${iconData["shortcode_txt"]} name="${iconData["name"]}"`;
    if (customClass) shortcode += ` class="${customClass}"`;
    if (customColor) shortcode += ` color="${customColor}"`;
    if (customSize) shortcode += ` size="${customSize}"`;
    if (customRotate) shortcode += ` rotate="${customRotate}"`;
    if (customCSS) shortcode += ` customcss="${customCSS}"`;
    shortcode += `]`;
    const newContent = (0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_2__.insert)(value, shortcode, value.start, value.end);
    onChange(newContent);
    closeModal();
  };
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_element__WEBPACK_IMPORTED_MODULE_4__.Fragment, null, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(_wordpress_block_editor__WEBPACK_IMPORTED_MODULE_3__.RichTextToolbarButton, {
    icon: "flag",
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Manager for Icomoon (Shortcode)', 'managerforicomoon'),
    onClick: openModal
    ...
    title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Manager for Icomoon (Shortcode version)', 'managerforicomoon')
  }));
}

/***/ }),

/***/ "./src/icon-shortcode/index.js":
/*!*************************************!*\
  !*** ./src/icon-shortcode/index.js ***!
  \*************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./style.scss */ "./src/icon-shortcode/style.scss");
/* harmony import */ var _edit__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./edit */ "./src/icon-shortcode/edit.js");




(0,_wordpress_rich_text__WEBPACK_IMPORTED_MODULE_1__.registerFormatType)('managerforicomoon/icon-shortcode', {
  title: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)('Manager for Icomoon (Shortcode)', 'managerforicomoon'),
  tagName: 'span',
  className: 'icomoon-icon-2',
  edit: _edit__WEBPACK_IMPORTED_MODULE_3__["default"]
});

/***/ }),

/***/ "./src/icon-shortcode/style.scss":
/*!***************************************!*\
  !*** ./src/icon-shortcode/style.scss ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/******/ 		var installedChunks = {
/******/ 			"icon-shortcode/index": 0,
/******/ 			"icon-shortcode/style-index": 0
/******/ 		};
/******/ 		
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["icon-shortcode/style-index"], () => (__webpack_require__("./src/icon-shortcode/index.js")))
